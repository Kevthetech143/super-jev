...
# against a live capture — see docs/wire-into-claude-code.md), so a lead call is always
...
# real shell parser — see docs/wire-into-claude-code.md "Gaps".
#
#   {
#     "hooks": {
#       "PreToolUse": [
...
# which is worse than the leash missing one write. See docs/wire-into-claude-code.md.
#
